...
public class Payment extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 537669943464497010L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Payment\",\"namespace\":\"com.learning.kallol.learnStreaming\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"double\"}]}");
   ...
   */
  public static com.learning.kallol.learnStreaming.Payment.Builder newBuilder() {
    return new com.learning.kallol.learnStreaming.Payment.Builder();
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static com.learning.kallol.learnStreaming.Payment.Builder newBuilder(com.learning.kallol.learnStreaming.Payment.Builder other) {
    if (other == null) {
      return new com.learning.kallol.learnStreaming.Payment.Builder();
    } else {
      return new com.learning.kallol.learnStreaming.Payment.Builder(other);
    }
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static com.learning.kallol.learnStreaming.Payment.Builder newBuilder(com.learning.kallol.learnStreaming.Payment other) {
    if (other == null) {
      return new com.learning.kallol.learnStreaming.Payment.Builder();
    } else {
      return new com.learning.kallol.learnStreaming.Payment.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Payment>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.learning.kallol.learnStreaming.Payment.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.learning.kallol.learnStreaming.Payment other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kallol.learnStreaming.Payment.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kallol.learnStreaming.Payment.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kallol.learnStreaming.Payment.Builder setAmount(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kallol.learnStreaming.Payment.Builder clearAmount() {
